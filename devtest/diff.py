...
if bbox != None:
    ...
    bbox = (max(0,bbox[0]-0.1*im1.size[0]),
            max(0,bbox[1]-0.1*im1.size[1]),
            min(im1.size[0],bbox[2]+0.1*im1.size[0]),
            min(im1.size[1],bbox[3]+0.1*im1.size[1]))
